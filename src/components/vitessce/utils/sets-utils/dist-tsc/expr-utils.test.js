...
import { stratifyExpressionData, aggregateStratifiedExpressionData, stratifyArrays, } from './expr-utils.js';
describe('Utility functions for processing expression data', () => {
    describe('stratifyExpressionData and stratifyArrays functions', () => {
        ...
        it('stratifyExpressionData: stratify by cell set, then sample set', () => {
            const [result, exprMax] = stratifyExpressionData(sampleEdges, sampleSets, sampleSetSelection, expressionData, obsIndex, mergedCellSets, geneSelection, cellSetSelection, cellSetColor, featureValueTransform, featureValueTransformCoefficient);
        ...
        it('stratifyArrays: stratifiy by cell set, then sample set', () => {
            ...
            const [result, cellCount] = stratifyArrays(sampleEdges, sampleIdToObsIdsMap, sampleSets, sampleSetSelection, alignedEmbeddingIndex, mergedCellSets, cellSetSelection, {

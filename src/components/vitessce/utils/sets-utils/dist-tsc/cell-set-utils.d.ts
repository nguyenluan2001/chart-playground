 ...
 * and cellColors is an object mapping cellIds to color [r,g,b] arrays.
 */
export function treeToSelectedSetMap(currTree: object, selectedNamePaths: array): array;
/**
 ...
 * and `color`.
 */
export function treeToObsIdsBySetNames(currTree: object, selectedNamePaths: array): object[];
/**
 * Given a tree with state, get the indices of observations
 * contained in each selected obs set.
 * @param {object} currTree A tree object.
 ...
 * and `color`.
 */
export function treeToObsIndicesBySetNames(currTree: object, selectedNamePaths: array, obsIndexMap: any): object[];
/**
